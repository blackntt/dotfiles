...
def FlagsForFile( filename, **kwargs ):
  return {
          'flags':['-Wall', '-Wextra', '-Wno-variadic-macros', '-fexceptions', '-DNDEBUG', '-DUNIT_TESTS', '-std=c++11', '-x', 'c++', '-I', 'src', '-I', 'include', '-isystem', '/usr/include', '-isystem', '/usr/local/include','-isystem','/usr/local/include/c++/v1'],
    }
# def Settings(**kwargs ):
#   return {
#           'flags':['-Wall', '-Wextra', '-Wno-variadic-macros', '-fexceptions', '-DNDEBUG', '-DUNIT_TESTS', '-std=c++11', '-x', 'c++', '-I', 'src', '-I', 'include', '-isystem', '/usr/include', '-isystem', '/usr/local/include','-isystem','/usr/local/include/c++/v1'],
